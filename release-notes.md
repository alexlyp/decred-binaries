...
- Allow reorg of block one [dcrd#745](decred/dcrd#745)
- blockchain: use the time source [dcrd#747](decred/dcrd#747)
- peer: Strictly enforce bloom filter service bit [dcrd#768](decred/dcrd#768)
- wire/peer: Implement feefilter p2p message [dcrd#779](decred/dcrd#779)
...
- rpctest: Cleanup resources on failed setup [dcrd#759](decred/dcrd#759)
- rpctest: Use ports based on the process id [dcrd#760](decred/dcrd#760)
- rpctest/deps: Update dependencies and API [dcrd#765](decred/dcrd#765)
- rpctest: Gate rpctest-based behind a build tag [dcrd#766](decred/dcrd#766)
- mempool: Add test for max orphan entry eviction [dcrd#769](decred/dcrd#769)
- fullblocktests: Add more consensus tests [dcrd#77](decred/dcrd#773)
- fullblocktests: Sync upstream block validation [dcrd#774](decred/dcrd#774)
- rpctest: fix a harness range bug in syncMempools [dcrd#778](decred/dcrd#778)
- secp256k1: Add regression tests for field.go [dcrd#781](decred/dcrd#781)
- secp256k1: Sync upstream test consolidation [dcrd#783](decred/dcrd#783)
- txscript: Correct p2sh hashes in json test data  [dcrd#785](decred/dcrd#785)
- txscript: Replace CODESEPARATOR json test data [dcrd#786](decred/dcrd#786)
- txscript: Remove multisigdummy from json test data [dcrd#789](decred/dcrd#789)
- txscript: Remove max money from json test data [dcrd#790](decred/dcrd#790)
- txscript: Update signatures in json test data [dcrd#791](decred/dcrd#791)
- txscript: Use native encoding in json test data [dcrd#792](decred/dcrd#792)
- rpctest: Store logs and data in same path [dcrd#780](decred/dcrd#780)
- txscript: Cleanup reference test code  [dcrd#793](decred/dcrd#793)

### Misc:
- Update deps to pull in additional logging changes [dcrd#734](decred/dcrd#734)
- Update markdown files for GFM changes [dcrd#744](decred/dcrd#744)
- blocklogger: Show votes, tickets, & revocations [dcrd#784](decred/dcrd#784)
- blocklogger: Remove STransactions from transactions calculation [dcrd#811](decred/dcrd#811)
