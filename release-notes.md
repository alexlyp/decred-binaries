...
To install Decrediton desktop wallet, download, uncompress, and run
[Decrediton Linux AppImage](https://github.com/decred/decred-binaries/releases/download/v2.0.6/decrediton-linux-amd64-v2.0.6.AppImage)
or 
[Decrediton Linux tar](https://github.com/decred/decred-binaries/releases/download/v2.0.6/decrediton-linux-amd64-v2.0.6.tar.gz)
or
[Decrediton macOS amd64](https://github.com/decred/decred-binaries/releases/download/v2.0.6/decrediton-darwin-amd64-v2.0.6.dmg)
or
[Decrediton macOS arm64](https://github.com/decred/decred-binaries/releases/download/v2.0.6/decrediton-darwin-arm64-v2.0.6.dmg)
or
[Decrediton Windows](https://github.com/decred/decred-binaries/releases/download/v2.0.6/decrediton-windows-amd64-v2.0.6.exe).

To install the command-line tools, please see
[dcrinstall](https://github.com/decred/decred-release/tree/master/cmd/dcrinstall).

See decred-v2.0.6-manifest.txt and the other manifest files for SHA-256 hashes
and the associated .asc signature files to confirm those hashes.
...
## Contents
* [dcrd](#dcrd-v206)
* [dcrwallet](#dcrwallet-v206)
* [Decrediton](#decrediton-v206)
...
* The websocket JSON-RPC client library has been updated to fix several data races and properly reconnect the RPC syncer if the connection is ever lost ([jrick/wsrpc#9](https://github.com/jrick/wsrpc/pull/9), [jrick/wsrpc#11](https://github.com/jrick/wsrpc/pull/11), [jrick/wsrpc#12](https://github.com/jrick/wsrpc/pull/12)).

* The SPV syncer will be recreated and reperform initial sync after all peers are lost ([`c11c84f2`](https://github.com/decred/dcrwallet/commit/c11c84f2)).

* To prevent spinning the CPU at 100%, the SPV syncer now adds per-peer incrementing backoffs after failed connection attempts ([`ba7027e8`](https://github.com/decred/dcrwallet/commit/ba7027e8)).

## Other improvements

* When forming an initial common set of mixing peers, all attempted sessions will now be considered, rather than only considering the most recent formation attempt.  This can result in peer agreement occurring sooner and with a larger set of peers ([decred/dcrd#3463](https://github.com/decred/dcrd/pull/3463)).

* When wallet is in the process of being shutdown, any ongoing mixes will be completed before the client and wallet process closes ([decred/dcrd#3467](https://github.com/decred/dcrd/pull/3467), [`b9bd675e`](https://github.com/decred/dcrwallet/commit/b9bd675e)).  For `csppsolver` users, this feature depends on deploying with the latest `csppsolver` release as well.

* The `version` JSON-RPC method now includes the `dcrwallet` version ([`9e3cbe03`](https://github.com/decred/dcrwallet/commit/9e3cbe03)).

* The `debuglevel` JSON-RPC method has been introduced, allowing the debug level of all or individual subsystems to be dynamically changed at runtime ([`c9d7e6a0`](https://github.com/decred/dcrwallet/commit/c9d7e6a0)).

## Changelog

The following lists all commits since dcrwallet v2.0.5:

* [`5d29910b`](https://github.com/decred/dcrwallet/commit/5d29910b): [release-v2.0] Prevent hang when dcrd connection is lost
* [`8e4b1da0`](https://github.com/decred/dcrwallet/commit/8e4b1da0): [release-v2.0] loader: Only create mix client if mixing enabled.
* [`b47c4de7`](https://github.com/decred/dcrwallet/commit/b47c4de7): [release-v2.0] version: Crank to 2.0.6
* [`08c2d3dd`](https://github.com/decred/dcrwallet/commit/08c2d3dd): [release-v2.0] Update wsrpc module
* [`ba7027e8`](https://github.com/decred/dcrwallet/commit/ba7027e8): [release-v2.0] spv: Implement per-peer increasing backoffs
* [`c11c84f2`](https://github.com/decred/dcrwallet/commit/c11c84f2): [release-v2.0] spv: Teardown syncer after all peers are lost
* [`b9bd675e`](https://github.com/decred/dcrwallet/commit/b9bd675e): [release-v2.0] Order mixclient and syncer shutdown
* [`9e3cbe03`](https://github.com/decred/dcrwallet/commit/9e3cbe03): [release-v2.0] Add dcrwallet version to version JSON-RPC result
* [`90e5291d`](https://github.com/decred/dcrwallet/commit/90e5291d): [release-v2.0] jsonrpc: Let client handle empty VSP policy fields
* [`61e7fbc4`](https://github.com/decred/dcrwallet/commit/61e7fbc4): [release-v2.0] Do not specify TLS curve preferences
* [`c9d7e6a0`](https://github.com/decred/dcrwallet/commit/c9d7e6a0): [release-v2.0] Implement the debuglevel JSON-RPC method
...
All commits since the last release may be viewed on GitHub
[here](https://github.com/decred/decrediton/compare/release-v2.0.5...release-v2.0.6).
...
All commits since the last release may be viewed on GitHub
[here](https://github.com/decred/decrediton/compare/release-v2.0.4...release-v2.0.5).
